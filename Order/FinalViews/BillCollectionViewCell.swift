...
class BillCollectionViewCell: UICollectionViewCell {
    ...
    func setupViews() {
        ...
        foodImageView.widthAnchor.constraint(equalTo: self.heightAnchor, multiplier: 1).isActive = true
...
//        foodPriceLabel.rightAnchor.constraint(equalTo: self.rightAnchor, constant: 0).isActive = true
